...
> Design notes for **ecommerce-password-reset-python** — a runnable python example that Typed Python service wiring captcha verification to an e-commerce password reset request.
...
- **Feature code** — the actual task: account recovery.
